...
const notices: Notice[] = [
  {
    ...
    category: "공지",
    categoryEn: "Notice",
    title: "제2회 APTRC 개최 및 오픈경기 참가 안내 (마감 4월 10일)",
    titleEn: "2nd APTRC Open Race Registration – Deadline April 10",
    date: "2026-03-31",
    summary:
      "제2회 아시아 태평양 트레일 러닝 챔피언십(APTRC)이 2026년 11월 중국 우이산에서 제11회 그랜드 우이산 슈퍼 트레일 레이스와 동시 개최됩니다. 아마추어 선수들이 참가할 수 있는 오픈경기(100/60/35/20/10km)의 참가 신청 마감은 4월 10일입니다.",
    summaryEn:
      "The 2nd Asia Pacific Trail Running Championships (APTRC) will be held in Wuyishan, China in November 2026, co-hosted with the 11th Grand Wuyi Super Trail Race. Open categories (100/60/35/20/10 km) are available to amateur runners. Registration closes April 10.",
