...
export default function AboutPage() {
  ...
  const leaders = [
    { role: locale === "ko" ? "회장" : "President", name: "—" },
    { role: locale === "ko" ? "부회장" : "Vice President", name: "—" },
    { role: locale === "ko" ? "사무총장" : "Secretary General", name: "—" },
  ];
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-16">
      ...
      <section>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          {leaders.map((leader) => (
            <div key={leader.role} className="border border-gray-200 rounded-xl p-5 text-center">
              ...
              <p className="font-medium text-gray-900 mt-1">{leader.name}</p>
            </div>
          ))}
        </div>
      </section>
